...
namespace CpTecnoCell
{
    ...
    {  
        ...
        private void limpiar()
        {
            ...
            cbxColorProducto.Text = string.Empty;
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            cbxColorProducto.SelectedValue = producto.color; // Asignar el color seleccionado
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (validar())
            {
                    ...
                    producto.usuarioRegistro = "administrador";//Util.usuario.usuario1;
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                ProductoCln.eliminar(id, "administrador");//Util.usuario.usuario1);
                listar();
