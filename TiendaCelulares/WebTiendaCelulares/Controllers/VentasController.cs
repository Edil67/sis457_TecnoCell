...
namespace WebTiendaCelulares.Controllers
{
    public class VentasController : Controller
    {
        ...
        {
            var finalTiendaCelularesContext = _context.Venta.Include(v => v.IdClienteNavigation).Include(v => v.IdUsuarioNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Id,IdCliente,IdUsuario,DocumentoCliente,MontoPago,MontoCambio,MontoTotal,UsuarioRegistro,FechaRegistro,Estado")] Venta venta)
        {
